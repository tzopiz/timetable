...
final class ChartView: TTBaseView {

    private let yAxisSeparator: UIView = {
        let view = UIView()
        view.backgroundColor = App.Colors.separator
        return view
    }()
    ...
    func configure(with data: [TTChartsView.Data], topChartOffset: Int) {
...
private extension ChartView {
    ...
    func drawDashLine(at yPosition: CGFloat) {
        ...
        dashLayer.strokeColor = App.Colors.separator.cgColor
    ...
    func drawChart(with data: [TTChartsView.Data], topChartOffset: Int) {
        ...
        chartLayer.strokeColor = App.Colors.active.cgColor
    ...
    func drawChartDot(at point: CGPoint) {
        ...
        dotLayer.strokeColor = App.Colors.active.cgColor
