...
enum App {
    ...
    enum Colors {
        ...
        static let active   = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
        ...
        static let WhiteBlack = UIColor.dynamic(light: #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1), dark: #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1))
