...
extension App {
    enum Images {
        ...
        static let checkmark_circle    = #imageLiteral(resourceName: "checkmark_circle@256x")
        static let circle = #imageLiteral(resourceName: "circle@256x.png")
        static let notification_point = #imageLiteral(resourceName: "notification_point")
        
        static let theme        = #imageLiteral(resourceName: "theme")
        static let person_crop_circle_fill = #imageLiteral(resourceName: "person_crop_circle_fill@128x")
        static let person_2_gobackward  = #imageLiteral(resourceName: "person_2_gobackward@256x")
        static let square_and_arrow_up        = #imageLiteral(resourceName: "square_and_arrow_up@256x")
        static let info_circle  = #imageLiteral(resourceName: "info_circle@256x")
        static let rectangle_portrait_and_arrow_forward         = #imageLiteral(resourceName: "rectangle_portrait_and_arrow_forward@256x")
        
        static let minus_circle = #imageLiteral(resourceName: "warning@128")
